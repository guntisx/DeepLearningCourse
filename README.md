...
-->
The above three unsolved Mysteries preventing true AI can be rephrased as follows (Reasoning needs concepts, concepts need grounding, grounding needs a world that generates data):
