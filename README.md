...
5. Architectures of Neural Networks: https://youtu.be/y6emEiI1lZw (Diffusion networks https://arxiv.org/abs/2402.04384 https://arxiv.org/abs/2411.02385 https://lilianweng.github.io)
...
11. Evolutionary Learning: https://youtu.be/4OTuG0WRjaU (Demo https://youtu.be/GOFws_hhZs8 Use https://youtu.be/IrLJEzUxIs0)
...
-->
The above three unsolved Mysteries preventing true AI (Reasoning needs concepts, concepts need grounding, grounding needs a world that generates data) can be rephrased as follows:
1. PHYSICAL object persistence in vision and touch, SLAM, concept creation (ontology-schema) and recognition (Occam razor causality in scene explanation), nouns and their instances (SYMBOLIC Language), 1-shot DB-like memory of instances.
...
This chain is true as one viable route to intelligence—the biological one, which is the existence proof we have. It's not obviously true as a necessary route ;-)
